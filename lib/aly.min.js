        ...
        var n = $("[data-hover-container]")
          ...
          , i = r({
            ...
            callback: function(n, o) {
                t.initPosition(e.eq(n).find("[data-base-layer]")),
                "light" == o ? a.trigger("change", "white") : "dark" == o ? a.trigger("change", "dark") : console.error("color\u65e0\u6548", o)
            }
        });
        !function() {
            i.auto.start(),
    ...
    t.exports = function(t) {
        ...
        var e = function(t) {
          ...
          , o = function(t) {
            ...
            $.extend(a, n.transition),
            t.selector.css(a).addClass("no-transition")
        }
          , r = function(t) {
          ...
          , c = function() {
            n.container = $(n.container).find("[data-base-layer]"),
            s(),
            n.layer.forEach(function(t) {
                o(t)
            }),
            i()
        }
...
, function(t, n) {
    t.exports = function(t, n, e) {
        var a, o, r, i = null , s = 0;
        e || (e = {});
        var u = function() {
            s = e.leading === !1 ? 0 : Date.now(),
            i = null ,
            r = t.apply(a, o),
            i || (a = o = null )
        }
        ...
        return function() {
            ...
            return a = this,
            o = arguments,
            0 >= l || l > n ? (i && (clearTimeout(i),
            i = null ),
            s = c,
            r = t.apply(a, o),
            i || (a = o = null )) : i || e.trailing === !1 || (i = setTimeout(u, l)),
            r
        }
    }
}
, function(t, n) {
    t.exports = function(t) {
        ...
        $.extend(n, t),
        n.group = n.container.find(n.group),
        n.step = n.group.outerHeight(),
        n.num = n.group.length,
        n.group.each(function(t, e) {
            $(e).addClass(n.bottom)
        });
        var e = function(t) {
          ...
          , a = function(t) {
            void 0 != t && n.nowIndex != t && (i(t),
            n.nowIndex = t,
            n.ul.find("li").eq(t).addClass("active").siblings().removeClass("active"))
        }
          , o = function() {
            n.ul.hover(function() {
                n.auto.pause()
          ...
          , r = function(t) {
            t || (t = "dark"),
            n.parent.removeClass("dark light").addClass(t).css({
          ...
          , i = function(t) {
            ...
            var a = n.group.eq(n.nowIndex)
              , o = n.group.eq(t);
            n.group.removeClass("animating-enter-up animating-enter-down"),
            a.addClass(n.bottom).removeClass(n.center),
            "up" == e ? o.addClass(n.center + " animating-enter-up").removeClass(n.bottom) : o.addClass(n.center + " animating-enter-down").removeClass(n.bottom);
            var i = o.data("active");
            r(i),
            n.callback(t, i),
            n.ul.removeClass("dark light").addClass(o.data("active"))
        }
          , s = function(t) {
...
!function(n) {
    function a(t) {
        ...
        return n[t].call(e.exports, e, e.exports, a),
        e.loaded = !0,
        e.exports
    }
    var i = {};
    ...
    function i(n) {
        ...
        function i(a) {
            ...
            function e() {
                u--,
                u >= 0 ? (i(),
                o = requestAnimationFrame(e)) : cancelAnimationFrame(o)
            }
            var o, r = $(a).find("[data-image]"), c = r.data("url"), u = 0, s = r.data("frame"), m = n.distance;
            r.css({
...
!function(e) {
    function u(t) {
        ...
        return e[t].call(i.exports, i, i.exports, u),
        i.loaded = !0,
        i.exports
    }
    var o = {};
...
, function(n, t) {
    function e(n) {
        ...
        if (!$)
            return console.error("need jQuery");
        var o = $(window)
          , i = o.height()
          , r = $("#" + n.container)
...
, function(t, i) {
    ...
    e.prototype = {
        ...
        initBtnsState: function() {
            this.size <= this.showSize && (this.leftBtn.hide(),
            this.leftBtn.prev("." + this.btnPreClazz).hide(),
            this.rightBtn.hide(),
            this.rightBtn.prev("." + this.btnPreClazz).hide())
        },
        bindEvent: function() {
            var t = this;
    ...
    function i(n) {
        ...
        function i(t) {
            ...
            function e() {
                s++,
                u > s ? (i(),
                a = requestAnimationFrame(e)) : cancelAnimationFrame(a)
            }
            function o() {
                s--,
                s >= 0 ? (i(),
                a = requestAnimationFrame(o)) : cancelAnimationFrame(a)
            }
            var a, r = $(t).find("[data-image]"), c = r.data("url"), s = 0, u = r.data("frame"), m = n.distance;
            r.css({
                "background-image": 'url("' + c + '")'
            }),
            $(t).hover(function() {
...
!function(n) {
    ...
    function a() {
        ...
        function e() {
            var n = function(n, t, e, a) {
              ...
              , e = {
                ...
                initFn: function(n) {
                    for (var a = parseInt(n), r = parseInt(NUMBER_CHANGE_TIME), o = a.toString().length, u = 1, s = 0; o - 1 > s; s++)
                        u *= 10;
        ...
        $.ajax({
            ...
            lastData: 0,
            success: function(n) {
                200 == n.code && ($(".ali-main-defence-wrapper").css("display", "block"),
                t(n.data))
            },
            error: function() {}
        })
...
, function(n, t) {
    n.exports = function(n) {
        ...
        function e() {
            d > f ? (f++,
            r = i.scrollTop() + o - m,
            r >= 0 && c > r && (p && (n.callback && n.callback(),
            p = !1),
            t(c - r))) : f = 0
        }
        var a = {
        ...
        $.extend(a, n);
        var r, i = $(window), o = i.height(), u = $("#" + a.container), s = u.outerHeight(), c = o + s, l = u.offset().top, f = 0, d = 10, m = l, p = !0;
        e(),
        i.on("scroll", e)
    }
}
, function(n, t, e) {
    ...
    !function(i, o) {
        ...
        var a = function(n, t, e, a, r, i) {
            ...
            for (var l in i)
                i.hasOwnProperty(l) && (c.options[l] = i[l]);
            ...
            c.formatNumber = function(n) {
                ...
                c.options.useGrouping)
                    for (; r.test(e); )
                        e = e.replace(r, "$1" + c.options.separator + "$2");
...
!function(i) {
    function t(n) {
        ...
        return i[n].call(o.exports, o, o.exports, t),
        o.loaded = !0,
        o.exports
    }
    var e = {};
    ...
    function n() {
        if (indexServe_isIE8) {
            ...
            for (var t = o({
                ...
                delayTime: 2250
            }), e = JSON.parse(serveDots), n = e.length, s = 0; n > s; s++)
                t.append(e[s])
    }
    e(1);
    var o = e(2);
...
, function(i, t) {
    i.exports = function(i) {
        ...
        return {
            append: function(r) {
                var d, l = r.width ? r.width : 150, v = $(e), c = $(n(r.name));
                ...
                "white" == r.type)
                    ...
                    if ("blue" != r.type)
                        return console.error("type\u53ea\u53ef\u4ee5\u4e3a[white|blue]");
...
, function(n, e) {
    n.exports = function(n) {
        ...
        function t() {
            f > l ? (l++,
            r = i.scrollTop() + a - p,
            r >= 0 && u > r && (g && (n.callback && n.callback(),
            g = !1),
            e(u - r))) : l = 0
        }
        var o = {
        ...
        $.extend(o, n);
        var r, i = $(window), a = i.height(), c = $("#" + o.container), s = c.outerHeight(), u = a + s, d = c.offset().top, l = 0, f = 10, p = d, g = !0;
        i.on("scroll", t)
    }
}
]);
...
!function(e) {
    ...
    function a(e) {
        ...
        $(window).scroll(function() {
            $(document).scrollTop() < 500 || s.get("aliyun_site") || s.get("intelligentClose") || t.user_cat_name_level1 || "close" == t.user_cat_name_level1 || (e.find(".solution-tip-mask").show(),
            $("body").append('<img height="0" width="0" style="display: none;" src="//ac.mmstat.com/aliyun.123.1?logtype=4&solutiontip=show"/>'))
        }),
        e.find(".step1 li").bind("click", function(t) {
            var i = this;
            $(i).hasClass("action") ? $(i).removeClass("action") : $(i).addClass("action"),
            n = !!e.find("li.action").length,
            n ? e.find(".un-click").removeClass("un-click") : e.find(".un-click").addClass("un-click");
            var o = e.find(".step2 .tip-links").eq(parseInt($(i).attr("site")) - 1);
            o.find("h4").html($(i).attr("h1")),
            o.find("p").html($(i).attr("p"))
        }),
        e.find(".un-click").click(function() {
            if (n) {
                {
                    var o = e.find("li.action");
                    parseInt(Math.random() * (0 - o.length - 1) + o.length - 1)
                }
                o.each(function(e, n) {
                    e || (t.user_cat_name_level1 = []),
                    t.user_cat_name_level1.push($(n).find("a").html()),
                    t.fromCookie = !0
                }),
                $("body").append('<img height="0" width="0" style="display: none;" src="//ac.mmstat.com/aliyun.123.1?logtype=4&solutiontip=submit"/>'),
                localStorage.setItem("intelligent", JSON.stringify(t)),
                e.find(".step1").hide(),
                e.find(".step2").show(),
                i = !0
            }
        }),
        e.find(".icon-wrong-w3").click(function() {
            e.find(".solution-tip-mask").hide(),
            s.set("intelligentClose", !0, {
                domain: ".aliyun.com",
                path: "/",
                expires: 15
            }),
    ...
    n(1);
    var l = $(".aliyun-index-solution-tip")
      , s = {
        set: function(e, t, n) {
            ...
            return document.cookie = [encodeURIComponent(e), "=", encodeURIComponent(t), n.expires ? "; expires=" + n.expires : "", n.path ? "; path=" + n.path : "", n.domain ? "; domain=" + n.domain : "", n.secure ? "; secure" : ""].join("")
        },
        get: function(e) {
            for (var t, n = document.cookie ? document.cookie.split("; ") : [], o = 0, a = n.length; a > o; o++) {
                var l = n[o].split("=")
                  , s = decodeURIComponent(l.shift())
                  , c = l.join("=");
                if (e === s) {
                    t = i(c);
                    break
